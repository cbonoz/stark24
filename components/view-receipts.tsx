...
const ViewReceipts = ({ pageId }: Props) => {
    ...
    async function getTransactions(address?: string, type?: string) {
        ...
        try {
            const res = await getTransactionsFromVoyager(address || pageId, page, type)
            const { data } = res
    ...
    return (
        <div className="min-w-[800px]">
            <div className="text-l text-gray-800 font-bold my-4">Lookup contract interactions by buyer address</div>
